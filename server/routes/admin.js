...
// DELETE /api/admin/channels/:channelId/messages/:messageId
...
// Admin kicks a user from channel
  ...
  try {
    ...
    await db.query(
      `INSERT INTO notifications (user_id, type, content, channel_id)
       VALUES (?, 'kicked', ?, ?)`,
      [targetUserId, `You were removed from a channel by admin`, channelId]
    );
